...
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\Poses2RotationsNN.pkl", "rb") as input_file:
...
while(True):
    ...
    line_floats = [round(float(x),12) for x in line[1:58]]
