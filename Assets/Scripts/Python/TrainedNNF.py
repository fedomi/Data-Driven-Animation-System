...
def readFile():
    N = 0
    file = open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionData_Test01.txt", "r")
    X = []
    j = 0
    for line in file:
        line_array = line.split(",")[1:]
        if(len(line_array) == 194):
...
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataTest01NN.pkl", "rb") as input_file:
