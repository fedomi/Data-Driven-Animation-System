...
def readFile():
    N = 0
    file = open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionData_Experiment2108.txt", "r")
    X0 = []
    X1 = []
    X2 = []
    X3 = []
...
def weight_pose(data):
    ...
    for i in range(0,len(data[0])):
        if i < 18:
            w_pose.append(0.002*data[0][i])  # leg joints
        elif i < 57:
            w_pose.append(0.002*data[0][i]) # other joints
        elif i >= 57 and i < 67:
...
# Loading models
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment2308NN01.pkl", "rb") as input_file:
    nn0 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment2308NN02.pkl", "rb") as input_file:
    nn1 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment2308NN03.pkl", "rb") as input_file:
    nn2 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment2308NN04.pkl", "rb") as input_file:
    nn3 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment2308NN05.pkl", "rb") as input_file:
    nn4 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment2308NN06.pkl", "rb") as input_file:
