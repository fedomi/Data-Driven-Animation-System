...
'''
mlreg = MLPRegressor(solver='adam', alpha=1e-5, max_iter = 100, verbose = 10, tol = 1e-10,
                     hidden_layer_sizes=(512, 512), random_state=1, n_iter_no_change = 23)
...
filename = 'F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionData011NN512_WS001e10.pkl'
