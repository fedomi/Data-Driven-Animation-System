...
def readFile():
    ...
    for line in file:
        ...
        if(n == 198):
            ...
            N = len(line_floats)
            if(interval(phase,0,5)):
                X0.append(line_floats)
            if(interval(phase,1,5)):
                X1.append(line_floats)
            if(interval(phase,2,5)):
                X2.append(line_floats)
            if(interval(phase,3,5)):
                X3.append(line_floats)
            if(interval(phase,4,5)):
                X4.append(line_floats)
    return X0,X1,X2,X3,X4, N
...
def weight_pose(data):
    ...
    for i in range(0,len(data[0])):
        if i < 18:
            w_pose.append(0.1*data[0][i])  # leg joints
        elif i < 57:
...
# Loading data
X0,X1,X2,X3,X4, N = readFile();

# Loading models
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment1608NN01.pkl", "rb") as input_file:
    nn0 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment1608NN02.pkl", "rb") as input_file:
    nn1 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment1608NN03.pkl", "rb") as input_file:
    nn2 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment1608NN04.pkl", "rb") as input_file:
    nn3 = pickle.load(input_file)
with open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionDataExperiment1608NN05.pkl", "rb") as input_file:
