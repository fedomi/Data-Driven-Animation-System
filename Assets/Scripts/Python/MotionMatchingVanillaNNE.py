...
def readFile():
    N = 0
    file = open("F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionData_020.txt", "r")
    X = []
    j = 0
    for line in file:
...
'''
mlreg = MLPRegressor(solver='adam', alpha=1e-5, max_iter = 500, verbose = 10, tol = 1e-10,
...
filename = 'F:\ProyectosUnity\VanillaMotionMatching\VanillaMotionMatching\Assets\Scripts\Python\MotionData020NN.pkl'
